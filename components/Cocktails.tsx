        ...
        >
          {cocktails.map((cocktail) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-md border border-white/10 rounded-lg p-6 md:p-8 hover:bg-white/15 transition-all duration-300"
            >
              <h3 className="font-[family-name:var(--font-heading)] text-lg md:text-xl font-semibold mb-2">
                {cocktail.name}
              </h3>
              <p className="text-text-secondary text-sm">{cocktail.desc}</p>
            </motion.div>
          ))}
        </motion.div>
