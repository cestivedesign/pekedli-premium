...
export default function Reservation() {
  ...
  const inp = 'w-full bg-white/[0.03] border border-white/[0.06] rounded-xl focus:border-accent/50 focus:bg-accent/5 text-text-primary py-4 px-5 outline-none transition-all duration-300 placeholder:text-text-muted text-base md:text-lg';
    ...
    <section id="foglalas" className="section-padding relative noise-overlay overflow-hidden">
      ...
      <div className="container-main relative z-10">
        ...
        <motion.form variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }}
          ...
          <button type="submit" className="btn-primary w-full !py-5 !text-sm md:!text-base">Asztal foglalása</button>
        </motion.form>
      </div>
    </section>
  );
