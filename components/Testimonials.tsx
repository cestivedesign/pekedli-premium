      ...
      <div className="container-main relative z-10">
        ...
        <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} className="max-w-3xl mx-auto">
          <div className="relative">
            <div className="card-3d p-10 md:p-16 text-center min-h-[320px] flex flex-col items-center justify-center !rounded-3xl">
              {/* Decorative quote */}
              <div className="font-heading text-6xl text-accent/20 leading-none mb-4">&ldquo;</div>
              ...
              <AnimatePresence mode="wait">
                <motion.div key={current} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} transition={{ duration: 0.4 }} className="max-w-lg mx-auto">
                  <p className="font-heading text-lg md:text-xl italic leading-relaxed mb-8 text-text-primary">
